...
vk::raii::ShaderModule CreateShaderModule(graphics::Device const& device,
                                          std::vector<char> const& code) {
  vk::ShaderModuleCreateInfo create_info{
      .codeSize = code.size(),
      .pCode = reinterpret_cast<const uint32_t*>(code.data())};
  vk::raii::ShaderModule shader_module{device.LogicalDevice(), create_info};
...
vk::raii::Pipeline graphics::PipelineBuilder::Compute(
  ...
  vk::raii::ShaderModule shader_module =
      CreateShaderModule(device, ReadFile(shader_filename));
  ...
  return {device.LogicalDevice(), nullptr, pipeline_info};
}

vk::raii::Pipeline graphics::PipelineBuilder::Graphics(
    graphics::Device const& device,
  ...
  return Graphics(device, binding_description, attribute_descriptions,
...
vk::raii::Pipeline graphics::PipelineBuilder::Graphics(
  ...
  vk::PipelineInputAssemblyStateCreateInfo input_assembly{
      .topology = options.topology, .primitiveRestartEnable = vk::False};
